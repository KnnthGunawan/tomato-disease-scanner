        ...
        <section className="grid gap-6 lg:grid-cols-[minmax(0,0.95fr)_minmax(360px,1.05fr)]">
          <div className="rounded-lg border border-leaf-100 bg-white p-5 shadow-soft">
            ...
            <button
              ...
              className="mt-5 inline-flex h-12 w-full items-center justify-center gap-2 rounded-lg bg-tomato-600 px-5 text-base font-semibold text-white transition hover:bg-tomato-500 disabled:cursor-not-allowed disabled:bg-slate-300"
            >
              {loading ? (
